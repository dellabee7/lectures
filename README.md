...
* **강의명:** 시스템분석설계 (System Analysis and Design)
* **수강 대상:** IT경영전공 3학년 (전공필수)
* **교수자:** [교수님 성함] (이메일주소@tukorea.ac.kr)
...
git clone [https://github.com/](https://github.com/)[본인ID]/SystemAnalysisDesign.git
Branch: 작업을 위한 브랜치를 생성합니다. (규칙: week01-name)

Commit & Push: 과제를 수행 후 커밋하고 본인 원격 저장소로 푸시합니다.

제출 경로: 03_Assignments/Week_XX/[학번_이름]/ 폴더 생성 후 업로드
