...
| 주차          | 주제                            | 핵심 활동                   | 파일 링크                       |
| ----------- | ----------------------------- | ----------------------- | --------------------------- |
| **Week 1**  | 오리엔테이션 & AX/DX 기초             | DX/AX 개념, 팀 구성, RACI    | [📄 week01.md](./week1.md)  |
| **Week 2**  | 프로젝트 캔버스                      | 캔버스 작성, SMART 목표        | [📄 week02.md](./week2.md)  |
| **Week 3**  | 서비스 분석 설계 & 요건 정의             | 문제 정의, As-Is/To-Be, SRS | [📄 week03.md](./week3.md)  |
| **Week 4**  | BMC & 시장 예측                   | BMC 9블록, TAM/SAM/SOM    | [📄 week04.md](./week4.md)  |
